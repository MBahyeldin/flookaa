...
CREATE TYPE event_target_type_enum AS ENUM ('USER', 'CHANNEL', 'POST', 'COMMENT');
CREATE TYPE owner_enum AS ENUM ('USER', 'CHANNEL');
...
CREATE INDEX idx_events_actor_event_created_at ON events (actor_id, name, created_at DESC);
